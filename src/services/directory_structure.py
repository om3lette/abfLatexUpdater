...
logger = create_logger('DirStructure', logging.INFO)
...
def verify_file_presence(repo_path: Path) -> tuple[Path, Path]:
    spec_file_name: str = ""
    hash_file_name: str = ""
    ...
    return Path.joinpath(repo_path, spec_file_name), Path.joinpath(repo_path, hash_file_name)
